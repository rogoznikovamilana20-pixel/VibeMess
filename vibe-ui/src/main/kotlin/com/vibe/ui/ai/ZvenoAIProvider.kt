...
class ZvenoAIProvider(
    private val apiKey: String = "",
    private val baseUrl: String = "https://api.zveno.ai/v1"
) : AiProvider {

    override val name: String = "ZvenoAI"
    override val isAvailable: Boolean = true

    override fun getDefaultModel(): String = "google/gemini-3-flash-preview"
        ...
        try {
            ...
            if (responseCode !in 200..299) {
                ...
                val msg = when (responseCode) {
                    401 -> "Неверный API-ключ ZvenoAI. Проверьте AI_API_KEY"
                    402 -> "Недостаточно средств. Пополните баланс в zveno.ai"
    ...
    override fun stream(
        ...
        try {
            ...
            throw AiException.Network("Ошибка соединения с ZvenoAI: ${e.message}")
        } finally {
            connection.disconnect()
        }
