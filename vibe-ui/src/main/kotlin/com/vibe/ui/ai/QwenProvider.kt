...
class QwenProvider(
    ...
    override fun getDefaultModel(): String = "qwen-plus"
        ...
        try {
            ...
            if (responseCode !in 200..299) {
                ...
                val msg = when (responseCode) {
                    401 -> "Неверный API-ключ Qwen. Проверьте AI_API_KEY в настройках"
    ...
    override fun stream(
        ...
        try {
            ...
            throw AiException.Network("Ошибка соединения с Qwen: ${e.message}")
        } finally {
            connection.disconnect()
        }
